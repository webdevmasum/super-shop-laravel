...
class OrderController extends Controller
{
    ...
    {        
        ...
        ->select("o.id","c.name as customer","c.mobile","o.order_date as date","o.paid_amount as Total Paid","o.shipping_address","o.vat","o.order_total")
        ->paginate(10);
    ...
    public function store(Request $request)
    {
        ...
        // print_r($order);
           ...
           $order->vat=isset($request->txtVat)?$request->txtVat:"90";
           $order->paid_amount=0;
           $order->order_total=isset($request->txtOrderTotal)?$request->txtOrderTotal:"80";
           $order->status_id=1;         
